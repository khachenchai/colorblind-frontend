        ...
        <div className="flex">
          <div className="w-1/2 mt-8">
            ...
            <div>
              ...
              <div>
                <button onClick={() => setRSetaDisplayType('number')} className="px-2 py-1 bg-green-400">ค่าตัวเลข</button>
                <button onClick={() => setRSetaDisplayType('graph')} className="px-2 py-1 bg-blue-400">กราฟ</button>
              </div>
            </div>
            <div>
